...
@jwtauth
class ProjectRequirementTestRoute(tornado.web.RequestHandler):
	def initialize(self):
		self.data = {}
	...
	def authorize(self, User):
		...
		self.Entity = self.DB.getEntity('ProjectRequirementTest')
	...
	def get(self, item_id = None ):
		Return = {}
		Columns = ['id', 'ordering', 'state', 'checked_out', 'checked_out_time', 'created_by', 'created_time', 'modified_by', 'modified_time', 'id_requirement', 'title', 'description']
