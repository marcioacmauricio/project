...
@jwtauth
class ProjectRequirementRoute(tornado.web.RequestHandler):
	def initialize(self):
		self.data = {}
	...
	def authorize(self, User):
		...
		self.Entity = self.DB.getEntity('ProjectRequirement')
	...
	def get(self, item_id = None ):
		Return = {}
		Columns = ['id', 'ordering', 'state', 'checked_out', 'checked_out_time', 'created_by', 'created_time', 'modified_by', 'modified_time', 'id_project', 'title', 'description', 'estimated_time', 'id_project_stage']
