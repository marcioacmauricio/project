...
@jwtauth
class MasterTablePermissionRoute(tornado.web.RequestHandler):
	def initialize(self):
		self.data = {}
	...
	def authorize(self, User):
		...
		self.Entity = self.DB.getEntity('MasterTablePermission')
	...
	def get(self, item_id = None ):
		Return = {}
		Columns = ['id', 'ordering', 'state', 'checked_out', 'checked_out_time', 'created_by', 'created_time', 'modified_by', 'table_name', 'permission', 'modified_time']
